...
import Outils.ToString
import Reflex
import Reflex.Dom
import WordAutWebAux.Widget
...
theContent :: (MonadWidget t m) => Maybe (ExpRat Char, Method) -> m ()
...
aux2 :: (MonadWidget t m) => Method -> ExpRat Char -> m ()
aux2 meth e =
  elAttr
    "div"
    ( Map.fromList
...
aux :: (MonadWidget t m) => Method -> ExpRat Char -> m ()
aux meth e =
  elAttr
    "div"
    ( Map.fromList
